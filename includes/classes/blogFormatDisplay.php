    ...
    public function blogFormatDisplay(){
        ...
        if ( has_post_format( 'aside' )) {
            // Displays the Aside Post Format
                 get_template_part('template-parts/post/format','aside');
          }  else if (has_post_format('quote')) {
             // Displays the Quote Post Format
              get_template_part('template-parts/post/format','quote');
          }  else if (has_post_format('link')) {
             // Displays the Link Post Format
              get_template_part('template-parts/post/format','link');
             ...
             // Displays the Gallery Post Format
              get_template_part('template-parts/post/format','gallery');
